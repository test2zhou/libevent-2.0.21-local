...
ACLOCAL = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/missing --run autoconf
AUTOHEADER = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/missing --run autoheader
AUTOMAKE = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
ZLIB_LIBS = -lz 
abs_builddir = /home/zhoujunjie/lib/libevent-2.0.21-local
abs_srcdir = /home/zhoujunjie/lib/libevent-2.0.21-local
abs_top_builddir = /home/zhoujunjie/lib/libevent-2.0.21-local
abs_top_srcdir = /home/zhoujunjie/lib/libevent-2.0.21-local
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /home/zhoujunjie/lib/libevent-2.0.21-local/install-sh
